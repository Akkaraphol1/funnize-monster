...
def draw(): # Pygame Zero draw function
    ...
    if gameStatus == 0: # display the title page
        ...
        screen.draw.text(player.name , center=(400, 400), owidth=0.5, ocolor=(255,0,0), color=(0,64,255) , fontsize=60)
    ...
    if gameStatus == 3:
        screen.blit('gaming rule1', (0, 0))

       
    if gameStatus == 4:
        screen.blit('botton2', (0, 0))

    if gameStatus == 5:
        screen.blit('provider1', (0, 0))
                
def drawCentreText(t):
    screen.draw.text(t , center=(400, 300), owidth=0.5, ocolor=(255,255,255), color=(255,64,0) , fontsize=60)
    
def update(): # Pygame Zero update function
    global moveCounter, player, gameStatus, lasers, level, boss,x1,y1
    if gameStatus == 0:
...
def start_game():
    global gameStatus,Time,score,MaxTime
    gameStatus = 1     
